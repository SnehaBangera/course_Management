...
public class TimetableView extends VerticalLayout {
    ...
    public TimetableView(CourseService courseService, SecurityService securityService) {
        ...
        try {
            if (!securityService.isLoggedIn() || !securityService.hasRole(Role.STUDENT)) {
            ...
            Paragraph description = new Paragraph("View your course schedule for the week (Indian Standard Time, 9:00 AM - 4:00 PM)");
    ...
    private void updateGrid() {
        try {
            ...
            List<Enrollment> enrollments = courseService.getStudentEnrollmentsWithSchedules(securityService.getCurrentUser());
            ...
            for (Enrollment enrollment : enrollments) {
                try {
                    ...
                    int scheduleCount = course.getSchedules() != null ? course.getSchedules().size() : 0;
                    ...
                    logger.error("Error processing course in enrollment: {}", courseEx.getMessage(), courseEx);
                    issues.add("Error processing a course in your enrollments");
                }
            }
            ...
            if (!hasValidSchedules) {
                ...
                if (!issues.isEmpty()) {
                    showNotification("Some issues occurred while loading your timetable. Please contact support if needed.", 
        ...
        try {
            ...
            coursesGrid.addColumn(enrollment -> {
                ...
                if (course.getSchedules() == null || course.getSchedules().isEmpty()) {
                    ...
                    return course.getSchedules().size() + " scheduled time(s)";
                }
            })
