...
public class MyCoursesView extends VerticalLayout {
    ...
    private void viewCourseContent(Course course) {
        try {
            ...
            Course courseWithMaterials = courseService.getCourseWithMaterials(course.getId());
            ...
            if (courseWithMaterials.getMaterials() != null && !courseWithMaterials.getMaterials().isEmpty()) {
                ...
                materialsGrid.addComponentColumn(material -> {
                    ...
                    downloadButton.addClickListener(e -> {
                        try {
                            String fileName = material.getFileName() != null ? 
                                material.getFileName() : material.getTitle() + ".pdf";
                                
                            StreamResource resource = new StreamResource(fileName,
                                () -> new ByteArrayInputStream(courseMaterialService.getFileData(material.getMaterialId())));
                            ...
                            UI.getCurrent().getPage().executeJs(
                                ...
                                "document.getElementById('download-link-" + material.getMaterialId() + "').remove();"
                            );
                        } catch (Exception ex) {
