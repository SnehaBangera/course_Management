...
public class CoursesView extends VerticalLayout {
    ...
    private void configureGrid() {
        ...
        grid.addColumn(Course::getCourseDescription).setHeader("Description").setAutoWidth(true);
    ...
    private void openCourseForm(Course course) {
        ...
        binder.bind(courseDescriptionField, Course::getCourseDescription, Course::setCourseDescription);
